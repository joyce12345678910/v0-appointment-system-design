      ...
      <nav className="border-b bg-card/95 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            {/* Logo - Gen-Z Admin Style */}
            <Link href="/admin" className="flex items-center gap-3 group">
              <div className="bg-gradient-to-br from-primary via-primary to-cyan-500 p-2 rounded-xl shadow-md group-hover:shadow-lg transition-all">
                <UserCog className="h-5 w-5 text-white" />
              </div>
              <div>
                <h2 className="font-bold text-lg bg-gradient-to-r from-primary to-cyan-600 bg-clip-text text-transparent">
                  Admin Panel
                </h2>
                <p className="text-xs text-muted-foreground font-medium">Tactay Billedo</p>
              </div>
            </Link>
                  ...
                  <div className="flex flex-col gap-3 mt-8">
                    <div className="mb-4 pb-4 border-b">
                      <div className="flex items-center gap-3">
                        <div className="bg-gradient-to-br from-primary via-primary to-cyan-500 p-2 rounded-xl">
                          <UserCog className="h-5 w-5 text-white" />
                        </div>
                        <div>
